  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-8 py-16 md:px-16 md:py-20">
        ...
        {/* Logos */}
        <div className="flex items-center justify-center gap-8 my-12 opacity-0" style={{
          animation: "word-appear 1s ease-out forwards",
          animationDelay: "1.8s"
        }}>
          <img 
            src={turnstileLogo} 
            alt="Turnstile" 
            className="h-16 w-16 md:h-20 md:w-20 transition-transform hover:scale-110 duration-300"
          />
          <img 
            src={solanaLogo} 
            alt="Solana" 
